    ...
    getmyBooking: async (userId) => {
      ...
      const bookings = result.rows.map(booking1 => {
        return {
          ...
          time_start: new Date(
            new Date(booking1.time_start).getFullYear(),
            new Date(booking1.time_start).getMonth(),
            new Date(booking1.time_start).getDate(),
            new Date(booking1.time_start).getHours(),
            new Date(booking1.time_start).getMinutes(),
            new Date(booking1.time_start).getSeconds(),
          ),
          time_end: new Date(
            new Date(booking1.time_end).getFullYear(),
            new Date(booking1.time_end).getMonth(),
            new Date(booking1.time_end).getDate(),
            new Date(booking1.time_end).getHours(),
            new Date(booking1.time_end).getMinutes(),
            new Date(booking1.time_end).getSeconds(),
          ),}
        });
        return bookings;
